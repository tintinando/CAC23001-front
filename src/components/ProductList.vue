<template>
    ...
    <Modal :modalVisible="editModalVisible" :closeModal="() => editModalVisible = false" :title="'Editar producto'">
        <AddProduct :editProduct="selectedProductToEdit" :forceFetch="() => isLoaded = false" :closeModal="() => editModalVisible = false"></AddProduct>
    </Modal>
</template>
...
export default {
    setup() {
        ...
        return { products, isLoaded, editModalVisible, handleDeleteProduct, selectedProductToEdit, handleEditProduct };
    },
